...
var colorBase = "#ff0";
var colorEscolta = "#382";
var colorAlero = "#0ff";
var colorAlaPivot = "#34f";
var colorPivot = "#586";
var pelota = "#fa0";
var colores = ["#ff0", "#382", "#0ff", "#34f", "#586", "#fa0"];
...
function draw() {
  ctx2.beginPath();
  var x = 150; // Coordenada x
  var y = 50; // Coordenada y
  var radius = 20; // Radio del arco
  var startAngle = 0; // Punto inicial del círculo
  var endAngle = Math.PI + (Math.PI * 2) / 2; // Punto final del círculo
  var anticlockwise = 1 % 2 == 0 ? false : true; // Sentido de las manecillas del reloj y contrario a ellas
